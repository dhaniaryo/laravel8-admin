            ...
            <div class="card-body">
                <form method="POST" action="/tambahdatajual/proses" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="nama_jual" class="col-md-4 col-form-label text-md-right">{{__('Nama Barang')}}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="created_by" class="col-md-4 col-form-label text-md-right">{{__('Pembuat Data Barang')}}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="status_jual" class="col-md-4 col-form-label text-md-right">{{ __('Status Barang') }}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">{{ __('Foto Barang') }}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="harga_jual" class="col-md-4 col-form-label text-md-right">{{ __('Harga Barang') }}</label>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-6 offset-md-4">
                            <a href="/datajualbarangsemua" class="btn btn-danger">Kembali</a>
